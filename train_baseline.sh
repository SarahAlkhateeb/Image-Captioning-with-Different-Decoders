...
python /datainbackup/2020-DAT450-DIT245/ronkkoj/group15/DIT245-image-captioning/train.py baseline --model baseline --max_caption_length -1 --batch_size 32 --epochs 1 --workers 32
